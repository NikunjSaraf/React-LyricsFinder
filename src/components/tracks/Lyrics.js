...
class Lyrics extends Component {
    ...
    componentDidMount(){
        ...
        &apikey=${process.env.REACT_APP_NN_KEY}`)
            .then(res => {
                ...
                <Fragment>
                    ...
                    <ul className="list-group mt-3">
                        ...
                        <li className="list-group-item">
                            ...
                            {track.primary_genres.music_genre_list[0]===undefined ? 'No Genre' : track.primary_genres.music_genre_list[0].music_genre.music_genre_name}
                        </li>
                        <li className="list-group-item">
